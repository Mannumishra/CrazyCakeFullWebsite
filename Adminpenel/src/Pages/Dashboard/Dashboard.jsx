  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch banners
        const bannersResponse = await axios.get('https://api.cakecrazzy.com/api/get-banners');
        setBanners(bannersResponse.data.data);

        // Fetch categories
        const categoriesResponse = await axios.get('https://api.cakecrazzy.com/api/get-main-category');
        setCategories(categoriesResponse.data.data);

        // Fetch sub-categories
        const subCategoriesResponse = await axios.get('https://api.cakecrazzy.com/api/get-subcategory');
        setSubCategories(subCategoriesResponse.data.data);

        // Fetch colors
        const colorsResponse = await axios.get('https://api.cakecrazzy.com/api/get-color');
        setColors(colorsResponse.data.data);

        // Fetch sizes
        const sizesResponse = await axios.get('https://api.cakecrazzy.com/api/get-size');
        setSizes(sizesResponse.data.data);

        // Fetch flowers
        const flowersResponse = await axios.get('https://api.cakecrazzy.com/api/get-flover');
        setFlowers(flowersResponse.data.data);


        // Fetch products
        const productsResponse = await axios.get('https://api.cakecrazzy.com/api/all-product');
        setProducts(productsResponse.data.data);

        // Fetch tags
        const tagsResponse = await axios.get('https://api.cakecrazzy.com/api/get-tags');
        ...
        // Fetch orders
        const ordersResponse = await axios.get('https://api.cakecrazzy.com/api/checkouts');
